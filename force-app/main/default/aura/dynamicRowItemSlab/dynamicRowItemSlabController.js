({
    doInit : function(component, event, helper) {
        console.log('tryyyyyyyyyyyyyyyyyyyyyyyye==slab'+JSON.stringify(component.get("v.oppLineItemInstance")));
    ...
    removeRow : function(component, event, helper){
      ...
      //  console.log('delete'+temp1.rowIndex);
        ...
        component.getEvent("DeleteRowEvt").setParams({"indexVar" :component.get("v.rowIndex"), "productId" :temp1.productid }).fire();
   ...
   /*     if(ListOfDependentFields.length > 0){
    ...
    check : function(component, event, helper) {
        ...
        if (allValid) {
            temp.getAllValuesSlab=true;
            component.set("v.oppLineItemInstance",temp);
        } else {
            temp.getAllValuesSlab=false;
            component.set("v.oppLineItemInstance",temp);
        }
        component.set("v.oppLineItemInstance", temp);
    }
