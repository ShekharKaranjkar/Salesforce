({
    ...
    getoneDList : function(component, event) {
        var oneDLists = event.getParam('arguments');
        if (oneDLists) {
            var oneDList = oneDLists.oneDListfromParent;
            console.log('oneDList'+JSON.stringify(oneDList));
