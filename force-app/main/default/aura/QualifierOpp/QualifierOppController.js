({ 
    ...
    doInit: function(component, event, helper) {
        //check that desing attribute
        //get your sObject attribute
        //var rec = get();
        //rec.sObjectType = 'Lead';
        //else
        //'Oppo'
  ...
  OnSubmit : function(component, event,helper) {
    ...
    var newLead = component.get("v.leadObj");
      ...
      //alert(newLead.Locations_for_transport_services__c);
      ...
      var b = component.get("v.leadObj.Have_you_mapped_decision_making_hierarch__c");
       var isexecute = true;
      if(newLead.Locations_for_transport_services__c !=undefined 
    ...
    console.log('newlwad'+JSON.stringify(newLead));
    action.setParams({ 
           ...
           var state = a.getState();
            if(state == "SUCCESS"){
                ...
                /*var newLead = {'sobjectType': 'Lead',
                                    'Locations_for_transport_services__c': ''
                                   };
